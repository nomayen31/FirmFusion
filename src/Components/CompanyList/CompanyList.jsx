...
const CompanyList = ({ data }) => {
  return (
    // Outer Section: Increased padding, max width, and a light background for modern contrast
    <section className="w-full px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-14">
        ...
        {/* Main Heading: Larger, bolder, with a modern gradient */}
        ...
        {/* Subtitle: More context, slightly lighter text */}
      ...
      {/* Grid Layout: Centered items with generous spacing */}
