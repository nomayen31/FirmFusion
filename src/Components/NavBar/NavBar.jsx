          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-neutral-400">
                FirmFusion is a smart job-finding platform that connects job  seekers with the right opportunities and helps companies hire top talent faster. Discover jobs, apply easily, and build your
                ...
                <li className="flex items-center text-neutral-400">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.125l-2.732 1.366a11.05 11.05 0 006.103 6.103l1.366-2.732a1 1 0 011.125-.502l4.493 1.498a1 1 0 01.684.948V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"
                    />
                  </svg>
                  +1800-001-658
                </li>
                <li className="flex items-center text-neutral-400">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12h-1.5z"
                    />
                  </svg>
                  info@firmfusion.com
                </li>
            ...
            <div className="flex justify-center pt-4 space-x-4">
              <a
                href="#"
                className="p-3 text-white transition-colors duration-300 rounded-full bg-neutral-800 hover:bg-blue-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                ...
                >
                  <path
                    fill="currentColor"
                    d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.962 3.652 9.096 8.438 9.873v-6.985H7.21V12h3.228V9.395c0-3.19 1.947-4.938 4.795-4.938 1.366 0 2.54.102 2.885.148v3.155h-1.874c-1.503 0-1.795.715-1.795 1.766V12h3.535l-.57 3.238h-2.965v6.985A10 10 0 0022 12z"
                  />
                </svg>
              </a>
              {/* ...other social icons */}
