...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="fixed w-[90%] mt-8 mx-auto rounded-xl z-50 py-4 top-0 left-0 right-0 bg-[#8473F5] shadow-lg transition-all duration-300">
        <div className="px-4 md:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <Link to="/" className="select-none">
                <span className="text-white text-2xl md:text-3xl font-extrabold tracking-tight drop-shadow-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                to="/login"
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-full transition-colors duration-300 shadow-lg"
              >
                Sign In
              </Link>
